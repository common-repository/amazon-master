...
<table class="widefat" cellspacing="0">
	<thead>
		<tr>
			<th colspan="2"><h2><img src="<?php echo plugins_url('images/techgasp-minilogo-16.png', dirname(__FILE__)); ?>" style="float:left; height:18px; vertical-align:middle;" /><?php _e('&nbsp;Latest News', 'amazon_master'); ?></h2></th>
		</tr>
	</thead>
...
<div class="fb-like-box" data-href="https://www.facebook.com/TechGasp" data-width="500" data-colorscheme="light" data-show-faces="false" data-header="false" data-stream="true" data-show-border="false"></div>
			...
			<td style="max-width:90%; height:auto; position: relative; display:block; margin:0 auto;">
				...
				<a href="https://wwww.techgasp.com/spam-master-2-million-threats-and-counting/" target="_blank"><img src="<?php echo plugins_url('images/techgasp-spam-master-2-million.jpg', dirname(__FILE__)); ?>" style="width:100% !important; height:100% !important; display:block;" /></a>
				...
				<p style="text-align:center;"><a class="button-primary" href="https://wwww.techgasp.com/spam-master-2-million-threats-and-counting/" target="_blank" title="Read More">Read More</a> <a class="button-primary" href="https://wordpress.org/plugins/spam-master/" target="_blank" title="Take a Peak">Take a Peak!</a></p>
			</td>
		</tr>
	</tbody>
</table>
